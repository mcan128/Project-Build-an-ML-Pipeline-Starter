...
if __name__ == "__main__":
    ...
    parser.add_argument(
        ...
        help = "Name of the input artifact to clean", ## INSERT DESCRIPTION HERE,
        required = True
    )
    ...
    parser.add_argument(
        "--output_artifact", 
        type = str, ## INSERT TYPE HERE: str, float or int,
        help = "Name of the cleaned output artifact", ## INSERT DESCRIPTION HERE,
        required = True
    )
    ...
    parser.add_argument(
        ...
        help = "Minimum price threshold for filtering", ## INSERT DESCRIPTION HERE,
        required = True
    )
    ...
    parser.add_argument(
        "--max_price",
        type = float, ## INSERT TYPE HERE: str, float or int,
        help = "Maximum price threshold for filtering", ## INSERT DESCRIPTION HERE,
        required = True
    )
